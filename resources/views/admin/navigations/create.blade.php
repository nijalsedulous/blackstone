...
@section('content')
    ...
    <!-- start: page -->
    <form id="frmcourier" action="{{route('navigations.store')}}" class="form-horizontal form-bordered" method="POST">
        {{csrf_field()}}
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-8">
                                        <label class="checkbox-inline">
                                            <input type="radio" id="inlineCheckbox1" name="nav_type" value="header"> Header
                                        </label>
                                        <label class="checkbox-inline">
                                            <input type="radio" id="inlineCheckbox2" name="nav_type" value="footer"> Footer
                                        </label>
                                ...
                                <div class="form-group @if ($errors->has('sort_order')) has-error  @endif">
                                    ...
                                    <div class="col-sm-8">
                                        <input type="number" min="1" class="form-control" name="sort_order" value="{{old('sort_order')}}">
