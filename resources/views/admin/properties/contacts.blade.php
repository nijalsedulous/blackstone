...
@section('content')
    ...
    <section class="panel">
        <div class="panel-body">
            <form id="frmcontact" action="{{route('properties.property_search_contact')}}" class="" method="POST" >
                {{csrf_field()}}
                <div class="row">
            ...
            <table class="table table-no-more table-bordered table-striped mb-none">
                ...
                @foreach($property_contacts as $key=> $contact)
                    ...
                    <tr>
                        ...
                        <td>
                            {!! Form::model($contact,['method' => 'DELETE', 'action' => ['PropertyController@delete_contact', $contact->id ], 'id'=>'frmdeletcontact_'.$contact->id ]) !!}
